...
public class Tier1Taint extends Block
{
     ...
     * Designed to annoy the crap out of you, will change surrounding blocks into it if the block isn't bedrock or a anti-taint wall, and will poison you when you're on it.
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if(par5Entity instanceof EntityLivingBase)
        {
            ...
            if(par1World.rand.nextInt(500)==0)
